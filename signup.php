...
<div class="container">
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input id="name" name="name" placeholder="First and last name" required="" onkeyup="this.value=this.value.replace(/[^a-z]/g,'');" tabindex="1" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['name']; } ?>"> 
